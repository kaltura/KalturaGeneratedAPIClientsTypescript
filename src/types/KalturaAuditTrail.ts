    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				relatedObjectType : { type : 'es'   , subType : 'KalturaAuditTrailObjectType'},
				entryId : { type : 's'   },
				masterPartnerId : { type : 'n'  , readOnly : true },
				partnerId : { type : 'n'  , readOnly : true },
				requestId : { type : 's'  , readOnly : true },
				userId : { type : 's'   },
				action : { type : 'es'   , subType : 'KalturaAuditTrailAction'},
				data : { type : 'o'   , fallbackConstructor :  KalturaAuditTrailInfo, subType : 'KalturaAuditTrailInfo'},
				ks : { type : 's'  , readOnly : true },
				context : { type : 'en'  , readOnly : true , subType : 'KalturaAuditTrailContext'},
