    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				srcFileSyncs : { type : 'a'  , subType : 'KalturaSourceFileSyncDescriptor'},
				engineVersion : { type : 'n'  },
				flavorParamsOutputId : { type : 'n'  },
				flavorParamsOutput : { type : 'o'  , subType : 'KalturaFlavorParamsOutput'},
				mediaInfoId : { type : 'n'  },
				currentOperationSet : { type : 'n'  },
				currentOperationIndex : { type : 'n'  },
				pluginData : { type : 'a'  , subType : 'KalturaKeyValue'}
            }
        );
        return result;
    }
