    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				fileObjectTypeEqual : { type : 'es'   , subType : 'KalturaFileSyncObjectType'},
				...
				statusEqual : { type : 'en'   , subType : 'KalturaFileSyncStatus'},
				statusIn : { type : 's'   },
				fileTypeEqual : { type : 'en'   , subType : 'KalturaFileSyncType'},
				fileTypeIn : { type : 's'   },
