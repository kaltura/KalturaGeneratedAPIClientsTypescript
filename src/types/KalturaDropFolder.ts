    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				name : { type : 's'   },
				description : { type : 's'   },
				type : { type : 'es'   , subType : 'KalturaDropFolderType'},
				status : { type : 'en'   , subType : 'KalturaDropFolderStatus'},
				conversionProfileId : { type : 'n'   },
				dc : { type : 'n'   },
				path : { type : 's'   },
				fileSizeCheckInterval : { type : 'n'   },
				fileDeletePolicy : { type : 'en'   , subType : 'KalturaDropFolderFileDeletePolicy'},
				autoFileDeleteDays : { type : 'n'   },
				fileHandlerType : { type : 'es'   , subType : 'KalturaDropFolderFileHandlerType'},
				fileNamePatterns : { type : 's'   },
				fileHandlerConfig : { type : 'o'   , fallbackConstructor :  KalturaDropFolderFileHandlerConfig, subType : 'KalturaDropFolderFileHandlerConfig'},
				tags : { type : 's'   },
