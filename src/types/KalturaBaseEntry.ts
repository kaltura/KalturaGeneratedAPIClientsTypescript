    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				status : { type : 'es'  , readOnly : true , subType : 'KalturaEntryStatus'},
				...
				replacementStatus : { type : 'es'  , readOnly : true , subType : 'KalturaEntryReplacementStatus'},
				...
				displayInSearch : { type : 'en'   , subType : 'KalturaEntryDisplayInSearchType'}
            }
        );
        return result;
    }
