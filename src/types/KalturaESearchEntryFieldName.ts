...
export class KalturaESearchEntryFieldName extends KalturaObjectBase {
	...
	static entryCreatorId = new KalturaESearchEntryFieldName('creator_puser_id');
	...
	static entryDisplayInSearch = new KalturaESearchEntryFieldName('display_in_search');
	static entryEndDate = new KalturaESearchEntryFieldName('end_date');
	static entryEntitledUserEdit = new KalturaESearchEntryFieldName('entitled_pusers_edit');
	static entryEntitledUserPublish = new KalturaESearchEntryFieldName('entitled_pusers_publish');
	...
	static entryUserId = new KalturaESearchEntryFieldName('puser_id');
}
