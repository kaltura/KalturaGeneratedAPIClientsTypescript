    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				metadataXslt : { type : 's'   },
				metadataXpathsTriggerUpdate : { type : 'a'   , fallbackConstructor :  KalturaStringValue, subType : 'KalturaStringValue'},
				...
				mapAccessControlProfileIds : { type : 'a'   , fallbackConstructor :  KalturaKeyValue, subType : 'KalturaKeyValue'},
				mapConversionProfileIds : { type : 'a'   , fallbackConstructor :  KalturaKeyValue, subType : 'KalturaKeyValue'},
				mapMetadataProfileIds : { type : 'a'   , fallbackConstructor :  KalturaKeyValue, subType : 'KalturaKeyValue'},
				mapStorageProfileIds : { type : 'a'   , fallbackConstructor :  KalturaKeyValue, subType : 'KalturaKeyValue'},
				mapFlavorParamsIds : { type : 'a'   , fallbackConstructor :  KalturaKeyValue, subType : 'KalturaKeyValue'},
				mapThumbParamsIds : { type : 'a'   , fallbackConstructor :  KalturaKeyValue, subType : 'KalturaKeyValue'},
				mapCaptionParamsIds : { type : 'a'   , fallbackConstructor :  KalturaKeyValue, subType : 'KalturaKeyValue'}
            }
        );
        return result;
    }
