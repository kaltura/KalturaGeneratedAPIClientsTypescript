    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				metadataXslt : { type : 's'  },
				metadataXpathsTriggerUpdate : { type : 'a'  , subType : 'KalturaStringValue'},
				...
				mapAccessControlProfileIds : { type : 'a'  , subType : 'KalturaKeyValue'},
				mapConversionProfileIds : { type : 'a'  , subType : 'KalturaKeyValue'},
				mapMetadataProfileIds : { type : 'a'  , subType : 'KalturaKeyValue'},
				mapStorageProfileIds : { type : 'a'  , subType : 'KalturaKeyValue'},
				mapFlavorParamsIds : { type : 'a'  , subType : 'KalturaKeyValue'},
				mapThumbParamsIds : { type : 'a'  , subType : 'KalturaKeyValue'},
				mapCaptionParamsIds : { type : 'a'  , subType : 'KalturaKeyValue'}
            }
        );
        return result;
    }
