    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				protocol : { type : 'es'   , subType : 'KalturaStorageProfileProtocol'},
				storageUrl : { type : 's'   },
				...
				pathManagerParams : { type : 'a'   , fallbackConstructor :  KalturaKeyValue, subType : 'KalturaKeyValue'},
				trigger : { type : 'n'   },
				deliveryPriority : { type : 'n'   },
				deliveryStatus : { type : 'en'   , subType : 'KalturaStorageProfileDeliveryStatus'},
				readyBehavior : { type : 'en'   , subType : 'KalturaStorageProfileReadyBehavior'},
