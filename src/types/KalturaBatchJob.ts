    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				jobSubType : { type : 'n'   },
				data : { type : 'o'   , fallbackConstructor :  KalturaJobData, subType : 'KalturaJobData'},
				...
				description : { type : 's'   },
				priority : { type : 'n'   },
				history : { type : 'a'   , fallbackConstructor :  KalturaBatchHistoryData, subType : 'KalturaBatchHistoryData'},
				bulkJobId : { type : 'n'   },
				batchVersion : { type : 'n'   },
				parentJobId : { type : 'n'   },
				rootJobId : { type : 'n'   },
