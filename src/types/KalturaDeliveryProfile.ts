    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				recognizer : { type : 'o'   , fallbackConstructor :  KalturaUrlRecognizer, subType : 'KalturaUrlRecognizer'},
				tokenizer : { type : 'o'   , fallbackConstructor :  KalturaUrlTokenizer, subType : 'KalturaUrlTokenizer'},
				isDefault : { type : 'en'  , readOnly : true , subType : 'KalturaNullableBoolean'},
				parentId : { type : 'n'  , readOnly : true },
				mediaProtocols : { type : 's'   },
				priority : { type : 'n'   },
				extraParams : { type : 's'   },
				supplementaryAssetsFilter : { type : 'o'   , fallbackConstructor :  KalturaAssetFilter, subType : 'KalturaAssetFilter'}
            }
        );
        return result;
    }
