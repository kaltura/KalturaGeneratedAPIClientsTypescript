    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				statusIn : { type : 's'  },
				auditObjectTypeEqual : { type : 'es'  , subType : 'KalturaAuditTrailObjectType'},
				auditObjectTypeIn : { type : 's'  },
				objectIdEqual : { type : 's'  },
				objectIdIn : { type : 's'  },
				relatedObjectIdEqual : { type : 's'  },
				relatedObjectIdIn : { type : 's'  },
				relatedObjectTypeEqual : { type : 'es'  , subType : 'KalturaAuditTrailObjectType'},
				...
				userIdEqual : { type : 's'  },
				userIdIn : { type : 's'  },
				actionEqual : { type : 'es'  , subType : 'KalturaAuditTrailAction'},
				actionIn : { type : 's'  },
				ksEqual : { type : 's'  },
				contextEqual : { type : 'en'  , subType : 'KalturaAuditTrailContext'},
				contextIn : { type : 's'  },
