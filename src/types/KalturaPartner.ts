    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				adminEmail : { type : 's'   },
				description : { type : 's'   },
				commercialUse : { type : 'en'   , subType : 'KalturaCommercialUseType'},
				landingPage : { type : 's'   },
				userLandingPage : { type : 's'   },
				contentCategories : { type : 's'   },
				type : { type : 'en'   , subType : 'KalturaPartnerType'},
				phone : { type : 's'   },
				describeYourself : { type : 's'   },
				adultContent : { type : 'b'   },
				defConversionProfileType : { type : 's'   },
				notify : { type : 'n'   },
				status : { type : 'en'  , readOnly : true , subType : 'KalturaPartnerStatus'},
				...
				country : { type : 's'   },
				state : { type : 's'   },
				additionalParams : { type : 'a'   , fallbackConstructor :  KalturaKeyValue, subType : 'KalturaKeyValue'},
				publishersQuota : { type : 'n'  , readOnly : true },
				partnerGroupType : { type : 'en'  , readOnly : true , subType : 'KalturaPartnerGroupType'},
				...
				deliveryTypes : { type : 'a'  , readOnly : true , fallbackConstructor :  KalturaPlayerDeliveryType, subType : 'KalturaPlayerDeliveryType'},
				embedCodeTypes : { type : 'a'  , readOnly : true , fallbackConstructor :  KalturaPlayerEmbedCodeType, subType : 'KalturaPlayerEmbedCodeType'},
