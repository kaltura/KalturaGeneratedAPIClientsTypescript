    ...
    protected _getMetadata() : KalturaObjectMetadata
    {
        ...
        Object.assign(
            result.properties,
            {
				...
				country : { type : 's'  },
				state : { type : 's'  },
				additionalParams : { type : 'a'  , subType : 'KalturaKeyValue'},
				...
				deliveryTypes : { type : 'a'  , readOnly : true, subType : 'KalturaPlayerDeliveryType'},
				embedCodeTypes : { type : 'a'  , readOnly : true, subType : 'KalturaPlayerEmbedCodeType'},
